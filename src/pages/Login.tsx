...
import { Users, Building, Shield, ArrowLeft, Shield as ShieldIcon } from "lucide-react";
...
const Login = () => {
  ...
  const handleLogin = (role: string) => {
    ...
    else if (role === "area-head") navigate("/area-head/dashboard");
  };
    ...
    <div className="min-h-screen bg-stone-50" style={gridStyle}>
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Resident Login */}
          <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full rounded-xl border-2 border-gray-200 bg-white/80 backdrop-blur-sm" onClick={() => handleLogin("resident")}>
            ...
            <CardContent className="pt-0">
              <div className="space-y-4">
                ...
                <Button className="w-full font-semibold bg-gradient-to-r from-blue-900 to-blue-800 text-white hover:from-blue-800 hover:to-blue-700 h-11 rounded-lg shadow-md transition-all duration-200">
                  Sign In as Resident
                </Button>
              </div>
            </CardContent>
          ...
          {/* Secretary Login */}
          <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full rounded-xl border-2 border-gray-200 bg-white/80 backdrop-blur-sm" onClick={() => handleLogin("secretary")}>
            <CardHeader className="text-center pb-2">
          ...
          {/* Area Head Login */}
          <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full rounded-xl border-2 border-gray-200 bg-white/80 backdrop-blur-sm" onClick={() => handleLogin("area-head")}>
            <CardHeader className="text-center pb-2">
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-600 text-sm bg-yellow-50 border border-yellow-200 rounded-lg p-3 max-w-md mx-auto">
            <span className="font-medium">Demo Mode:</span> Click any card above to instantly access the respective dashboard
          </p>
        </div>
      </div>
    </div>
